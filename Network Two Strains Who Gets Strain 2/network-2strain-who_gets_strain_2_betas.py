...
def main():
    ...
    for beta in betas:
        ...
        print(f"beta = {beta:.2f} -> Outbreak rate: {np.mean(n_var2_outbreaks):.3f}, Susceptible: {np.mean([res[6] for res in results]):.3f}, Vaccinated: {np.mean([res[7] for res in results]):.3f}, Recovered: {np.mean([res[8] for res in results]):.3f}")
    ...
    plt.plot(betas, infected_susceptible_1, marker='o', linestyle='-', label="Susceptible")
    plt.plot(betas, infected_vaccinated_1, marker='o', linestyle='-', label="Vaccinated ")
    plt.plot(betas, infected_recovered_strain_1_1, marker='o', linestyle='-', linewidth=4, label="Recovered from Strain 1")

    plt.xlabel(r"$\beta$ (Infection Rate)", fontsize=20)
    plt.ylabel("Number of Infected", fontsize=20)
    ax = plt.gca()
    ...
    plt.figure(figsize=(8, 5))
    plt.plot(betas, infected_susceptible_2, marker='o', linestyle='-', label="Susceptible")
    plt.plot(betas, infected_vaccinated_2, marker='o', linestyle='-', label="Vaccinated")
    plt.plot(betas, infected_recovered_strain_1_2, marker='o', linestyle='-', linewidth=4, label="Recovered from Strain 1")
    ...
    # -------------------------
    plt.figure(figsize=(8, 5))
    plt.plot(np.array(betas), outbreak_probabilities_1, marker='o', linestyle='-', label=f"Assortativity low ({a_1})")
    plt.plot(np.array(betas), outbreak_probabilities_2, marker='o', linestyle='-', label=f"Assortativity high ({a_2})")
